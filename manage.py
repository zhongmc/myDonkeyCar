...
from zmcrobot.zmcrobot import ZMCRobot
from jetbotcar.jetbotcar import JetbotCar
...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[] ):
    ...
    if camera_type == "stereo":
        ...
        if cfg.DONKEY_GYM:
            ...
            from donkeycar.parts.camera import Webcam
            cam = Webcam(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, iCam = cfg.CAMERA_ICAM)
        elif cfg.CAMERA_TYPE == "CVCAM":
            from donkeycar.parts.cv import CvCam
            cam = CvCam(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH)
        elif cfg.CAMERA_TYPE == "CSIC":
            from donkeycar.parts.camera import CSICamera
            cam = CSICamera(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, framerate=cfg.CAMERA_FRAMERATE, gstreamer_flip=cfg.CSIC_CAM_GSTREAMER_FLIP_PARM, capture_width=cfg.CAPTURE_WIDTH, capture_height=cfg.CAPTURE_HEIGHT)
    ...
    elif cfg.DRIVE_TRAIN_TYPE == "ZMC_ROBOT":
        zmcRobot = ZMCRobot(port=cfg.ZMC_ROBOT_PORT, baud=cfg.ZMC_ROBOT_BAUD,timeout=10.0, maxw=cfg.ZMC_ROBOT_MAXW, maxv = cfg.ZMC_ROBOT_MAXV)
        V.add(zmcRobot, inputs=['throttle','angle'], outputs=['x','y','theta','w','v'])
    elif cfg.DRIVE_TRAIN_TYPE == "JETBOT":
        jetbotCar = JetbotCar(addr=cfg.JETBOT_ADDR, i2c_bus=cfg.JETBOT_I2C_BUS, 
        left_motor_channel = cfg.JETBOT_LEFT_CHANNEL, left_alpha=cfg.JETBOT_LEFT_ALPHA, 
        right_motor_channel = cfg.JETBOT_RIGHT_CHANNEL, right_alpha=cfg.JETBOT_RIGHT_ALPHA)
        V.add(jetbotCar, inputs=['throttle', 'angle'] )
