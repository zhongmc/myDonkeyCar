...
#CAMERA_ICAM=1  # for multi webcam /dev/video0 1 2
# camera.py  image-w image-h  capture_width capture height not work for csic camera
CAPTURE_WIDTH=1280
CAPTURE_HEIGHT=720
...
IMAGE_H = 240
IMAGE_DEPTH = 3         # default RGB=3, make 1 for mono
CAMERA_ICAM=0  # for multi webcam /dev/video0 1 2
...
# 
DRIVE_TRAIN_TYPE="ZMC_ROBOT"
ZMC_ROBOT_PORT="/dev/ttyACM0"
ZMC_ROBOT_BAUD=115200
ZMC_ROBOT_MAXW=1.5
ZMC_ROBOT_MAXV=0.2
...
STEERING_RIGHT_PWM = 120        #pwm value for full right steering
# 
# #THROTTLE
...
#JetBot car
#DRIVE_TRAIN_TYPE="JETBOT"
JETBOT_ADDR=0x60
JETBOT_I2C_BUS=1
JETBOT_LEFT_CHANNEL=1
JETBOT_RIGHT_CHANNEL=2
JETBOT_LEFT_ALPHA=0.91
JETBOT_RIGHT_ALPHA=1
